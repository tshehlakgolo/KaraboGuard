...
export default function App() {
  ...
  const sos = () => {
    ...
    if (nums.length === 0) {
      Alert.alert("Add numbers", "Type numbers like 27716809393 in boxes below");
      return;
    }
    const msg = "🚨 KARABOGUARD HELP! I need help now! Please call me. My location: https://maps.google.com/?q=-26.2041,28.0473";
  ...
  return (
    <ScrollView contentContainerStyle={s.box}>
      ...
      <Text style={s.sub}>V7.4 - Will Open 100%</Text>
      
      <TouchableOpacity style={s.sos} onPress={sos}>
        <Text style={s.sosT}>🚨 TAP FOR SOS 🚨</Text>
        <Text style={s.small}>Silent vibration + WhatsApp</Text>
      </TouchableOpacity>
      ...
      <View style={s.card}>
        ...
        <Text style={s.hint}>Tip: 071 -> 2771. Each person who downloads adds their own 3 people.</Text>
      </View>
    </ScrollView>
  );
}
...
const s = StyleSheet.create({
  ...
  small: { color: 'white', fontSize: 11, marginTop: 4 },
